...
// BSON tags MUST NOT be changed — the compression system reads these exact field names.
...
// PontonScreenConfiguration is the root document read from MongoDB's screen_configuration collection.
